...
2. **Name Pattern** (20% weight): Detects firstname+digits patterns
3. **Email Pattern** (15% weight): Identifies shared domains and disposable emails
4. **Single Repository** (10% weight): Finds accounts focused on one repo
5. **Coordinated Behaviour** (30% weight): Network analysis and writing similarity
6. **Temporal Clustering** (10% weight): Detects time-based coordination
...
This tool is designed to detect security threats. If you discover a security vulnerability, please email security@yourdomain.com.
